...
export default function Home() {
      ...
      <div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <Card className="text-center">
            ...
            <p className="text-gray-600 mb-6">Tu rol: <strong>{user.tipo}</strong></p>
            <Button onClick={() => router.push(dashboardPath[user.tipo])} size="lg">
              Ir al Dashboard
            </Button>
          </Card>
        </div>
  ...
  return (
    <div>
      <Navbar />
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-12">Sistema de Almacenes y Depósitos</h1>
